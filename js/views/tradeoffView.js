...
const CHANNEL_LABEL = { dns: 'DNS', icmp: 'ICMP echo', timing: 'Timing', storage: 'Storage', ordering: 'Packet ordering', http: 'HTTP header order', physical: 'Air-gap optical', cache: 'Shared cache' };
